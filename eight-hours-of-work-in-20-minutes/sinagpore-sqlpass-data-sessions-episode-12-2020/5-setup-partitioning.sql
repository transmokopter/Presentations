...
--2019-05-01 is our last referencedate. 
--Rightmost range value = 2019-05-01 + 1 month
--(because I want an empty rightmost partition)
--I also want an empty leftmost partition, 
--Since I use RANGE RIGHT, I will get a partition to "the left of" 2019-01-01
