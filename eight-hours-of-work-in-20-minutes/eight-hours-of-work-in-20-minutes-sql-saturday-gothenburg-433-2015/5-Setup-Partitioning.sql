...
--2013-10-31 is first referencedate. That's our first data-partition.
--2013-11-30 is the last referencedate. 
--Rightmost range value = 2013-11-30 + 1 month
...
CREATE PARTITION FUNCTION [pf_DEMO](date) AS RANGE RIGHT FOR VALUES 
	(
		N'2013-10-31', N'2013-11-30',N'2013-12-31');
GO
