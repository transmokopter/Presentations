...
ALTER DATABASE [sqlsaturday433] MODIFY FILE 
	( NAME = N'sqlsaturday433', FILEGROWTH = 1024000KB )
GO
ALTER DATABASE [sqlsaturday433] 
	MODIFY FILE ( NAME = N'sqlsaturday433_log', FILEGROWTH = 8000KB )
GO
use SqlSaturday433;
GO
...
CREATE PROC Demo.GenerateCSV(@dt date)
AS
	select
	@dt AS ReferenceDate,
