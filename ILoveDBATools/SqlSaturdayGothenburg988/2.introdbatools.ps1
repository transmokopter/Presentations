...
#Get output as table 
Get-DbaService -Server localhost -Type Engine | Select-Object -Property ComputerName, ServiceType, ServiceName, Description, @{Name='ServiceStatus';Expression={$_.State}} | Format-Table;
