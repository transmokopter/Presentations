...
values ('2019-02-01','123','123','123','123','SE','stuff','123','123','SE','SEK',1,'SEK',1,1,1,1,'')
...
SELECT @ReferenceDate = (SELECT TOP 1 ReferenceDate FROM Demo.ProductionSales_Staging )
...
BEGIN
	...
	SET @nextBound = 
		dateadd(day,-1,dateadd(month,1,DATEADD(day,1,cast(@ReferenceDate as DATE))));
	...
	exec sp_executesql @s;
	--Get the partitionID of the next partition
