...
BEGIN 
	...
	CREATE DATABASE [ssd]
	 CONTAINMENT = NONE
	 ON  PRIMARY 
	( NAME = N'ssd', FILENAME = N'c:\sqldata\MSSQL13.MSSQLSERVER\MSSQL\Data\ssd.mdf' , SIZE = 1024000KB , FILEGROWTH = 512000KB )
	 LOG ON 
	( NAME = N'ssd_log', FILENAME = N'c:\sqldata\MSSQL13.MSSQLSERVER\MSSQL\Data\ssd_log.ldf' , SIZE = 512000KB , FILEGROWTH = 512000KB )
END 
...
EXEC xp_cmdshell 'DEL D:\SQLDATA\ssd_frag_test*.xel', no_output
...
ADD TARGET package0.event_file(SET filename=N'd:\sqldata\ssd_frag_test')
...
INTO myXeData
FROM sys.fn_xe_file_target_read_file('d:\sqldata\ssd_frag_test*.xel', NULL, NULL, NULL);
